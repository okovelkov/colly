...
[![GoDoc](https://godoc.org/github.com/okovelkov/colly?status.svg)](https://godoc.org/github.com/okovelkov/colly)
[![Backers on Open Collective](https://opencollective.com/colly/backers/badge.svg)](#backers) [![Sponsors on Open Collective](https://opencollective.com/colly/sponsors/badge.svg)](#sponsors) [![build status](https://img.shields.io/travis/okovelkov/colly/master.svg?style=flat-square)](https://travis-ci.org/okovelkov/colly)
[![report card](https://img.shields.io/badge/report%20card-a%2B-ff3333.svg?style=flat-square)](http://goreportcard.com/report/okovelkov/colly)
[![view examples](https://img.shields.io/badge/learn%20by-examples-0077b3.svg?style=flat-square)](https://github.com/okovelkov/colly/tree/master/_examples)
[![Code Coverage](https://img.shields.io/codecov/c/github/okovelkov/colly/master.svg)](https://codecov.io/github/okovelkov/colly?branch=master)
...
See [examples folder](https://github.com/okovelkov/colly/tree/master/_examples) for more detailed examples.


## Installation

```
go get -u github.com/okovelkov/colly/...
```


## Bugs

Bugs or suggestions? Visit the [issue tracker](https://github.com/okovelkov/colly/issues) or join `#colly` on freenode
...
<a href="https://github.com/okovelkov/colly/graphs/contributors"><img src="https://opencollective.com/colly/contributors.svg?width=890" /></a>
